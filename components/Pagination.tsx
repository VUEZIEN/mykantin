      ...
      <div className="items-center hidden md:flex gap-x-3">
        {pages.pages.map((pageItem, index) => (
          <button
            ...
            className={clsx(
              `min-h-[38px] min-w-[38px] flex justify-center items-center `,
              {
                "border border-gray-200 text-gray-800 py-2 px-3 text-sm rounded-lg focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none ": page === pageItem,
                "":
                  page !== pageItem,
              },
              {}
