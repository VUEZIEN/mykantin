  ...
  return (
    <div id="root" className=" overflow-hidden">
      ...
      <main className="relative h-full overflow-hidden">
            ...
            <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
              <div className="text-center">
                <p className="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3 ">
                  Cari Produck Berkualiatas
                </p>
                <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight ">
                  Lanjutkan dengan belanja online
                  <span className="text-blue-500"> 24 jam</span>
                </h1>
              </div>
              <a
                href="/produk"
                className="cursor-pointer flex items-center justify-center bg-slate-950 w-36 h-12 rounded-xl text-white  hover:bg-white hover:border-2 hover:border-slate-950 hover:text-black transition-all duration-300 mx-auto"
              >
                Cari Produck
              </a>
        ...
        <section className="relative -mx-32 sm:-mx-10 md:-mx-2 lg:-mx-0 -z-10 -mt-40 bg-transparent">
          <div className="max-w-4xl relative justify-items-center gap-5 items-center grid-flow-col mx-auto grid grid-cols-4 ">
            <figure className="col-start-4 row-end-2">
              <img
                src="https://images.unsplash.com/photo-1559289431-9f12ee08f8b6?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-32 h-32 rounded-xl shadow-custom row-start-3 object-cover"
              />
            </figure>
            <figure className=" col-start-3 row-end-3">
              <img
                src="https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGNhcnN8ZW58MHx8MHx8fDA%3D"
                alt=""
                className="w-32 h-32 rounded-xl shadow-custom object-cover"
              />
            </figure>
            <figure className="col-start-2 row-end-3">
              <img
                src="https://images.unsplash.com/photo-1587614297882-0954a02d57f7?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-32 h-32 rounded-xl shadow-custom object-cover"
              />
            </figure>
            <figure className="row-end-2 row-span-2">
              <img
                src="https://images.unsplash.com/photo-1537589376225-5405c60a5bd8?q=80&w=2864&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-32 h-32 rounded-xl shadow-custom object-cover"
              />
            </figure>
        ...
        <>
          <section className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div className="mt-20 grid gap-6 grid-cols-2 justify-items-center sm:gap-12 lg:grid-cols-3 lg:gap-9">
              <div>
                ...
                <p className="mt-1 text-gray-500">Di semua orders</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-cyan-600">
                  349,000+
                </p>
                <p className="mt-1 text-gray-500">Bergabung dengan Protucs</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-green-600">
                  95%
                </p>
                <p className="mt-1 text-gray-500">Menurut tahun ini</p>
              </div>
            </div>
          </section>
        </>
