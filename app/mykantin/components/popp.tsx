...
const DishDetailModal: React.FC<Item> = ({
  dishItem,
  isDisabled,
  ...props
}) => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2">
      <div className="bg-white p-8 w-[689px] rounded-2xl shadow-2xl drop-shadow-2xl">
        <picture>
          <img
            src={dishItem.image}
            alt=""
        ...
        <span className="flex justify-between items-center">
          ...
          <h2 className="font-medium text-3xl">{dishItem.harga}</h2>
        </span>
        ...
        <p className="text-justify">
          ...
          sapiente consequatur et excepturi fugit amet ducimus quasi ex tempora
          reprehenderit, error suscipit recusandae perferendis, quaerat, quo
          aspernatur. Aliquam, a suscipit.
        </p>
        ...
        <div className="flex justify-between">
          ...
          <button className="w-[200px] justify-center gap-2 h-auto flex  bg-primary-yellow rounded-2xl items-center">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
