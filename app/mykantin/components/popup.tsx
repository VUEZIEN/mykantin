...
const DishDetailModal: React.FC<Item> = ({ dishItem, isDisabled, onClose}) => {
  ...
  return (
    <>
        <div
          ref={modalRef}
          className="fixed top-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center items-center left-1/2 z-50 "
        >
